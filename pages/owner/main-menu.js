...
function MainMenuContent() {
  ...
  const iconMap = {
    ...
    'Purchase Orders':    { name: 'Purchase Orders',      desc: 'Vendor PO & procurement management',   icon: <FaShoppingCart />, color: '#8b5cf6', bg: '#f5f3ff', cat: 'Operations', url: '/owner/purchase-orders' },
    'Purchases & Reports':{ name: 'Purchase Orders',      desc: 'Vendor PO & procurement management',   icon: <FaShoppingCart />, color: '#8b5cf6', bg: '#f5f3ff', cat: 'Operations', url: '/owner/purchase-orders' },
    'Purchases':          { name: 'Purchase Orders',      desc: 'Vendor PO & procurement management',   icon: <FaShoppingCart />, color: '#8b5cf6', bg: '#f5f3ff', cat: 'Operations', url: '/owner/purchase-orders' },
